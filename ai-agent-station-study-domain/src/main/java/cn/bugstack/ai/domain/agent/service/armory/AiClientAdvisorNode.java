...
public class AiClientAdvisorNode extends AbstractArmorySupport {
    ...
    /** PgVector 数据源 JdbcTemplate，用于 BM25 全文检索；PgVector 未配置时为 null */
    ...
    private Advisor createAdvisor(AiClientAdvisorVO aiClientAdvisorVO) {
        ...
        return advisorTypeEnum.createAdvisor(aiClientAdvisorVO, vectorStore, pgVectorJdbcTemplate, chatModel);
    }
